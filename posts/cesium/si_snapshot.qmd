...
pointdata = {
    ...
    const query = `SELECT h3, h3_cell_to_lat(h3) as latitude, h3_cell_to_lng(h3) as longitude, cast(log(count(*)) as integer) as n from occurrence where h3 is not null group by h3`;
